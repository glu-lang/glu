...
/// @class OSSAInst
/// @brief Base class for all OSSA (Ownership Static Single Assignment) instructions.
///
/// This class serves as the base for all ownership-related instructions in the GIL.
/// OSSA instructions handle ownership semantics including moves, copies, borrows,
...
public:
    ...
    /// @brief Performs LLVM-style RTTI to check if an instruction is an OSSAInst.
