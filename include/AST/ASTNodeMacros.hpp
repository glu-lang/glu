...
#define GLU_AST_GEN_CHILDREN_TRAILING_OBJECTS(Self, num, Child, Name)        \
    using TrailingParams = llvm::TrailingObjects<Self, Child>;               \
    friend TrailingParams;                                                   \
                                                                             \
    unsigned num;                                                            \
    size_t numTrailingObjects(typename TrailingParams::OverloadToken<Child>) \
        const                                                                \
    {                                                                        \
        return num;                                                          \
    }                                                                        \
    ...
    {                                                                        \
        return { getTrailingObjects<Child>(), num };                         \
    }                                                                        \
                                                                             \
public:                                                                      \
